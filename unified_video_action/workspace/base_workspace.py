...
class BaseWorkspace:
    ...
    def load_payload(self, payload, exclude_keys=None, include_keys=None, reset_lr=False, **kwargs):
        if exclude_keys is None:
            exclude_keys = tuple()
        if include_keys is None:
        ...
        if (
            ("lr_scheduler" not in self.__dict__ or reset_lr)
    ...
    def load_checkpoint(
        self, path=None, tag="latest", exclude_keys=None, include_keys=None, reset_lr=False, **kwargs
    ):
        if path is None:
        ...
        self.load_payload(payload, exclude_keys=exclude_keys, include_keys=include_keys, reset_lr=reset_lr)
        return payload
