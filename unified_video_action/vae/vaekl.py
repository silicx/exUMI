...
class AutoencoderKL(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        self.encoder = Encoder(ch_mult=ch_mult, z_channels=embed_dim, num_res_blocks=num_res_blocks)
        self.decoder = Decoder(ch_mult=ch_mult, z_channels=embed_dim, num_res_blocks=num_res_blocks)
