...
from unified_video_action.common.sampler import SequenceSamplerUMI, get_val_mask
from unified_video_action.dataset.base_dataset import BaseDataset
...
class UmiDataset(BaseDataset):
    ...
    def get_validation_dataset(self):
        ...
        val_set.sampler = SequenceSamplerUMI(
    ...
    def __getitem__(self, idx: int) -> Dict[str, torch.Tensor]:
        ...
        for key in self.rgb_keys:
            ...
            imgs = data[key]
            obs_dict[key] = np.moveaxis(imgs, -1, 1).astype(np.float32) / 255.
